  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-600 text-white rounded-2xl shadow-lg px-8 py-10 mb-12 text-center">
        <h1 className="text-4xl font-bold mb-3">Environmental Champions</h1>
      ...
      <div className="bg-white shadow-xl overflow-hidden rounded-xl border border-green-100">
        <div className="bg-green-50 px-6 py-5 border-b border-green-100">
          <h2 className="text-2xl font-semibold text-green-800">Leaderboard Rankings</h2>
          <p className="text-green-700 mt-1">Top waste collectors making a difference</p>
        </div>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {leaderboardData.length > 0 ? (
              ...
              <tr>
                <td colSpan="3" className="px-6 py-12 text-base text-gray-500 text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto text-gray-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                  </svg>
                  <p className="text-lg font-medium">No data available. Be the first to contribute!</p>
                  <p className="mt-2">Start collecting and reporting waste to earn points.</p>
                </td>
              </tr>
            )}
          </tbody>
      ...
      <div className="mt-12 bg-green-700 rounded-xl shadow-lg p-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="/collect" className="px-6 py-3 bg-white text-green-700 font-semibold rounded-lg shadow hover:bg-green-50 transition-colors">
            Collect Waste
          </a>
